  ...
  return UI.If(function() {                                                                                            // 11
    ...
    return [ "\n    ", HTML.DIV({                                                                                      // 15
      ...
      str: "×"                                                                                                         // 35
                                                                                                                       ...
                                                                                                                       // 39
Template.__define__("_justResetPasswordDialog", (function() {                                                          // 40
  var self = this;                                                                                                     // 41
  var template = this;                                                                                                 // 42
  return UI.If(function() {                                                                                            // 43
    return Spacebars.call(self.lookup("visible"));                                                                     // 44
  }, UI.block(function() {                                                                                             // 45
    var self = this;                                                                                                   // 46
    return [ "\n    ", HTML.DIV({                                                                                      // 47
      "class": "accounts-dialog accounts-centered-dialog"                                                              // 48
    }, "\n      Password reset.\n      You are now logged in as ", function() {                                        // 49
      return Spacebars.mustache(self.lookup("displayName"));                                                           // 50
    }, ".\n      ", HTML.DIV({                                                                                         // 51
      "class": "login-button",                                                                                         // 52
      id: "just-verified-dismiss-button"                                                                               // 53
    }, "Dismiss"), "\n    "), "\n  " ];                                                                                // 54
  }));                                                                                                                 // 55
}));                                                                                                                   // 56
                                                                                                                       // 57
Template.__define__("_enrollAccountDialog", (function() {                                                              // 58
  var self = this;                                                                                                     // 59
  var template = this;                                                                                                 // 60
  return UI.If(function() {                                                                                            // 61
    return Spacebars.call(self.lookup("inEnrollAccountFlow"));                                                         // 62
  }, UI.block(function() {                                                                                             // 63
    var self = this;                                                                                                   // 64
    return [ "\n    ", HTML.DIV({                                                                                      // 65
      "class": "hide-background"                                                                                       // 66
    }), "\n\n    ", HTML.DIV({                                                                                         // 67
      "class": "accounts-dialog accounts-centered-dialog"                                                              // 68
    }, "\n      ", HTML.LABEL({                                                                                        // 69
      id: "enroll-account-password-label",                                                                             // 70
      "for": "enroll-account-password"                                                                                 // 71
    }, "\n        Choose a password\n      "), "\n\n      ", HTML.DIV({                                                // 72
      "class": "enroll-account-password-wrapper"                                                                       // 73
    }, "\n        ", HTML.INPUT({                                                                                      // 74
      id: "enroll-account-password",                                                                                   // 75
      type: "password"                                                                                                 // 76
    }), "\n      "), "\n\n      ", Spacebars.include(self.lookupTemplate("_loginButtonsMessages")), "\n\n      ", HTML.DIV({
      "class": "login-button login-button-form-submit",                                                                // 78
      id: "login-buttons-enroll-account-button"                                                                        // 79
    }, "\n        Create account\n      "), "\n\n      ", HTML.A({                                                     // 80
      "class": "accounts-close",                                                                                       // 81
      id: "login-buttons-cancel-enroll-account"                                                                        // 82
    }, HTML.CharRef({                                                                                                  // 83
      html: "&times;",                                                                                                 // 84
      str: "×"                                                                                                         // 85
    })), "\n    "), "\n  " ];                                                                                          // 86
                                                                                                                       ...
                                                                                                                       // 89
Template.__define__("_justVerifiedEmailDialog", (function() {                                                          // 90
  var self = this;                                                                                                     // 91
  var template = this;                                                                                                 // 92
  return UI.If(function() {                                                                                            // 93
    return Spacebars.call(self.lookup("visible"));                                                                     // 94
  }, UI.block(function() {                                                                                             // 95
    var self = this;                                                                                                   // 96
    return [ "\n    ", HTML.DIV({                                                                                      // 97
      "class": "accounts-dialog accounts-centered-dialog"                                                              // 98
    }, "\n      Email verified.\n      You are now logged in as ", function() {                                        // 99
      return Spacebars.mustache(self.lookup("displayName"));                                                           // 100
    }, ".\n      ", HTML.DIV({                                                                                         // 101
...
Template.__define__("_configureLoginServiceDialog", (function() {                                                      // 108
  ...
  return UI.If(function() {                                                                                            // 111
    return Spacebars.call(self.lookup("visible"));                                                                     // 112
  }, UI.block(function() {                                                                                             // 113
    var self = this;                                                                                                   // 114
    return [ "\n    ", HTML.DIV({                                                                                      // 115
      id: "configure-login-service-dialog",                                                                            // 116
      "class": "accounts-dialog accounts-centered-dialog"                                                              // 117
    }, "\n      ", Spacebars.include(self.lookupTemplate("configurationSteps")), "\n\n      ", HTML.P("\n        Now, copy over some details.\n      "), "\n      ", HTML.P("\n        ", HTML.TABLE("\n          ", HTML.COLGROUP("\n            ", HTML.COL({
      span: "1",                                                                                                       // 119
      "class": "configuration_labels"                                                                                  // 120
    }), "\n            ", HTML.COL({                                                                                   // 121
      span: "1",                                                                                                       // 122
      "class": "configuration_inputs"                                                                                  // 123
    }), "\n          "), "\n          ", UI.Each(function() {                                                          // 124
      return Spacebars.call(self.lookup("configurationFields"));                                                       // 125
    }, UI.block(function() {                                                                                           // 126
      var self = this;                                                                                                 // 127
      return [ "\n            ", HTML.TR("\n              ", HTML.TD("\n                ", HTML.LABEL({                // 128
        "for": [ "configure-login-service-dialog-", function() {                                                       // 129
          return Spacebars.mustache(self.lookup("property"));                                                          // 130
        } ]                                                                                                            // 131
      }, function() {                                                                                                  // 132
        return Spacebars.mustache(self.lookup("label"));                                                               // 133
      }), "\n              "), "\n              ", HTML.TD("\n                ", HTML.INPUT({                          // 134
        id: [ "configure-login-service-dialog-", function() {                                                          // 135
          return Spacebars.mustache(self.lookup("property"));                                                          // 136
        } ],                                                                                                           // 137
        type: "text"                                                                                                   // 138
      }), "\n              "), "\n            "), "\n          " ];                                                    // 139
    })), "\n        "), "\n      "), "\n      ", HTML.DIV({                                                            // 140
      "class": "new-section"                                                                                           // 141
    }, "\n        ", HTML.DIV({                                                                                        // 142
      "class": "login-button configure-login-service-dismiss-button"                                                   // 143
    }, "\n          I'll do this later\n        "), "\n        ", HTML.A({                                             // 144
      "class": "accounts-close configure-login-service-dismiss-button"                                                 // 145
    }, HTML.CharRef({                                                                                                  // 146
      html: "&times;",                                                                                                 // 147
      str: "×"                                                                                                         // 148
    })), "\n\n        ", HTML.DIV({                                                                                    // 149
      "class": [ "login-button login-button-configure ", UI.If(function() {                                            // 150
        return Spacebars.call(self.lookup("saveDisabled"));                                                            // 151
      }, UI.block(function() {                                                                                         // 152
        var self = this;                                                                                               // 153
        return "login-button-disabled";                                                                                // 154
      })) ],                                                                                                           // 155
      id: "configure-login-service-dialog-save-configuration"                                                          // 156
    }, "\n          Save Configuration\n        "), "\n      "), "\n    "), "\n  " ];                                  // 157
  }));                                                                                                                 // 158
}));                                                                                                                   // 159
                                                                                                                       // 160
Template.__define__("_loginButtonsMessagesDialog", (function() {                                                       // 161
  var self = this;                                                                                                     // 162
  var template = this;                                                                                                 // 163
  return UI.If(function() {                                                                                            // 164
    return Spacebars.call(self.lookup("visible"));                                                                     // 165
  }, UI.block(function() {                                                                                             // 166
    var self = this;                                                                                                   // 167
    return [ "\n    ", HTML.DIV({                                                                                      // 168
      "class": "accounts-dialog accounts-centered-dialog",                                                             // 169
      id: "login-buttons-message-dialog"                                                                               // 170
    }, "\n      ", Spacebars.include(self.lookupTemplate("_loginButtonsMessages")), "\n      ", HTML.DIV({             // 171
      "class": "login-button",                                                                                         // 172
      id: "messages-dialog-dismiss-button"                                                                             // 173
    }, "Dismiss"), "\n    "), "\n  " ];                                                                                // 174
  }));                                                                                                                 // 175
}));                                                                                                                   // 176
                                                                                                                       // 177
...
//# sourceMappingURL=4567e3da09d5e81789340f9ce7ba9dfd4ca855bc.map
